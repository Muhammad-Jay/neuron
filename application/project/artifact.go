...
// system key is persisted. It lives in the project's .neuron directory, but
// outside .neuron/resolved so that command-invoked re-resolves (which clean the
// resolved artifact) do not invalidate the registration.
